...
static const struct kem_algorithm algorithms[] = {
    {"ECDHE-P-256", KEM_ECDH, -1, ECC_SECP256R1, 32, 65, 32, 65, 32},
    {"ECDHE-P-384", KEM_ECDH, -1, ECC_SECP384R1, 48, 97, 48, 97, 48},
    {"ECDHE-P-521", KEM_ECDH, -1, ECC_SECP521R1, 66, 133, 66, 133, 66},
    {"MLKEM512", KEM_MLKEM, WC_ML_KEM_512, 0, 0, 800, 1632, 768, 32},
    {"MLKEM768", KEM_MLKEM, WC_ML_KEM_768, 0, 0, 1184, 2400, 1088, 32},
    {"MLKEM1024", KEM_MLKEM, WC_ML_KEM_1024, 0, 0, 1568, 3168, 1568, 32},
    {"SecP256r1MLKEM768", KEM_HYBRID_ECDH, WC_ML_KEM_768,
     ECC_SECP256R1, 32, 1249, 2432, 1153, 64},
    {"X25519MLKEM768", KEM_HYBRID_X25519, WC_ML_KEM_768,
     0, 32, 1216, 2432, 1120, 64},
    {"SecP384r1MLKEM1024", KEM_HYBRID_ECDH, WC_ML_KEM_1024,
