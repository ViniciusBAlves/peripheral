...
from benchmarklib.algorithms import KEMS_BY_NAME
from run_kem_benchmarks import attempt_row, read_kem_cases, summarize
        ...
        with tempfile.TemporaryDirectory() as directory:
            ...
            with path.open("w", newline="") as stream:
                writer = csv.DictWriter(
                    stream, fieldnames=["enabled", "kex_group"]
                )
                writer.writeheader()
